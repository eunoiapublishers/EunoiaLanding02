...
const avatarColors = [
  "bg-[#5B3DB5]/30 text-white border-[#5B3DB5]/40",
  "bg-[#19B7C9]/30 text-white border-[#19B7C9]/40",
  "bg-[#F05D9B]/30 text-white border-[#F05D9B]/40"
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {TESTIMONIALS.map((test, idx) => (
            <motion.div
              ...
              className="bg-white/[0.02]/30 backdrop-blur-md border border-white/10 p-8 rounded-[2rem] shadow-xl flex flex-col justify-between relative group skew-card transition-all"
            >
              
              {/* Decorative Quote Mark */}
              <div className="absolute top-4 right-6 text-white/5 group-hover:scale-110 transition-transform duration-300">
              ...
              <div className="flex flex-col gap-4 relative z-10">
                ...
                {/* 5-Star Rating */}
                <div className="flex gap-1 bg-white/5 px-2.5 py-1 rounded-full w-fit border border-white/5">
                  {[...Array(5)].map((_, sIdx) => (
                ...
                <p className="font-sans text-slate-200 text-sm md:text-base leading-relaxed italic">
                  "{test.quote}"
                </p>
              ...
              <div className="flex items-center gap-4 mt-8 border-t border-dashed border-white/10 pt-4 relative z-10">
                ...
                {/* Title Details */}
                <div>
                  <h4 className="font-heading font-black text-sm md:text-base text-white">
                    {test.name}
                  </h4>
                  <span className="font-sans text-[11px] md:text-xs text-slate-400 font-semibold block">
