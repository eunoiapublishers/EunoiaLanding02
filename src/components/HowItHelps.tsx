...
const borderHoverColors = [
  "hover:border-[#5B3DB5]/60 hover:bg-white/[0.06] border-white/10",
  "hover:border-[#19B7C9]/60 hover:bg-white/[0.06] border-white/10",
  "hover:border-[#F05D9B]/60 hover:bg-white/[0.06] border-white/10"
];

export default function HowItHelps() {
  return (
    <section id="benefits" className="py-20 md:py-28 px-4 md:px-8 bg-transparent border-b border-white/10">
      <div className="max-w-7xl mx-auto">
        
        {/* Section Heading */}
        <div className="text-center max-w-2xl mx-auto mb-20 bg-white/[0.03] backdrop-blur-xl p-6 md:p-8 rounded-[2.5rem] border border-white/15 shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {HOW_IT_HELPS_PILLARS.map((pillar, idx) => (
            <motion.div
              ...
              className={`flex flex-col bg-white/[0.03] backdrop-blur-lg rounded-3xl border p-6 shadow-xl skew-card transition-all ${borderHoverColors[idx]}`}
            >
              
              {/* Pillar Image / Mockup Screenshot */}
              <div className="w-full h-48 rounded-2xl overflow-hidden mb-6 relative group border border-white/10">
              ...
              <p className="font-sans text-slate-350 text-sm md:text-base leading-relaxed flex-grow">
                {pillar.description}
              </p>
