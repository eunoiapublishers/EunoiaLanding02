...
const cardColors = [
  "hover:bg-[#F05D9B]/10 hover:border-[#F05D9B]/50 border-stone-200",
  "hover:bg-[#ebdcfc]/10 hover:border-[#ebdcfc]/50 border-stone-200",
  "hover:bg-[#19B7C9]/10 hover:border-[#19B7C9]/50 border-stone-200",
  "hover:bg-[#FFD86A]/10 hover:border-[#FFD86A]/50 border-stone-200",
  "hover:bg-[#ebdcfc]/10 hover:border-[#ebdcfc]/50 border-stone-200"
];

export default function Problem() {
  return (
    <section id="problem" className="py-16 md:py-24 px-4 md:px-8 bg-transparent border-b border-stone-200 relative">
