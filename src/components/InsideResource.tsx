...
export default function InsideResource() {
  ...
  return (
    <section id="inside" className="py-20 md:py-28 px-4 md:px-8 bg-transparent border-b border-white/10 relative">
      <div className="max-w-7xl mx-auto">
        
        {/* Section Title */}
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 bg-white/5 text-[#19B7C9] font-heading font-bold text-xs md:text-sm px-4 py-2 border border-white/10 rounded-full mb-3 backdrop-blur-md">
        ...
        {/* Carousel Framework */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center bg-white/[0.03] backdrop-blur-xl rounded-[2.5rem] border border-white/15 shadow-2xl p-6 md:p-10">
          
          {/* Left Block: Image Viewport with interactive arrows */}
          <div className="lg:col-span-7 flex flex-col items-center">
            <div className="relative w-full aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl border border-white/15 bg-slate-950/45 flex items-center justify-center">
              ...
              <button
                onClick={handlePrev}
                className="absolute left-3 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-slate-900/80 hover:bg-slate-900 text-white flex items-center justify-center shadow-lg border border-white/15 hover:scale-105 transition-all z-20 cursor-pointer"
              ...
              <button
                onClick={handleNext}
                className="absolute right-3 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-slate-900/80 hover:bg-slate-900 text-white flex items-center justify-center shadow-lg border border-white/15 hover:scale-105 transition-all z-20 cursor-pointer"
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 justify-center">
            ...
            <p className="font-sans text-slate-350 text-base md:text-md leading-relaxed bg-white/[0.04] p-4 rounded-2xl border border-dashed border-white/15">
              {SLIDES[current].desc}
            </p>

            {/* Quick checklist of values in the printable kit */}
            <ul className="flex flex-col gap-2.5">
              <li className="flex items-center gap-2.5 text-sm font-sans text-slate-320">
