...
const SLIDES = [
  {
    image: `${import.meta.env.BASE_URL}mockup.png`,
  ...
  {
    image: `${import.meta.env.BASE_URL}picture01.png`,
  ...
  {
    image: `${import.meta.env.BASE_URL}picture02.png`,
  ...
  {
    image: `${import.meta.env.BASE_URL}board_example.png`,
