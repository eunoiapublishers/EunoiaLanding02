...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-lg border-b border-stone-200 py-3.5 px-4 md:px-8">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          ...
          <div className="flex flex-col">
            <span className="font-heading font-black text-base md:text-xl text-stone-900 tracking-tight leading-tight">
              Eunoia Learning
            </span>
            <span className="font-sans text-[10px] md:text-xs text-stone-500 hidden sm:inline">
        ...
        {/* Dynamic Nav Links */}
        <nav className="hidden md:flex items-center gap-6 font-sans font-bold text-xs md:text-sm text-stone-600">
          <button 
            onClick={() => handleScroll('problem')} 
            className="hover:text-[#F05D9B] transition-colors cursor-pointer"
          >
            The Problem
          </button>
          <button 
