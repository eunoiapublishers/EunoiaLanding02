...
export default function FinalCTA() {
  return (
    <section className="relative overflow-hidden py-24 px-4 md:px-8 text-stone-900 text-center border-t border-stone-200">
      
      {/* Heavy glass card overlay inside the full layout section */}
      <div className="max-w-5xl mx-auto bg-white/40 backdrop-blur-xl rounded-[3.5rem] border border-stone-200 p-8 md:p-16 shadow-2xl relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto flex flex-col items-center gap-8 relative z-10">
          ...
          <div className="flex gap-2.5 items-center justify-center bg-white backdrop-blur-md px-5 py-2.5 rounded-full border border-stone-200 text-[#FFD86A] font-heading font-bold text-xs md:text-sm">
          ...
          {/* Big Headline */}
          <h2 className="font-heading font-black text-3xl md:text-5xl lg:text-6xl text-stone-900 leading-tight tracking-tight max-w-3xl">
            Help Children Learn Patience, Confidence, and Self-Regulation
          </h2>

          {/* Sub-headline */}
          <p className="font-sans text-stone-600 text-base md:text-lg lg:text-xl max-w-2xl leading-relaxed">
          ...
          >
            <a
              ...
              target="_blank"
              rel="no-referrer"
              className="inline-flex items-center gap-3 bg-[#F05D9B] hover:bg-[#d94481] text-white font-heading font-black text-lg md:text-xl px-10 py-5 rounded-full shadow-2xl shadow-[#F05D9B]/25 border border-stone-200 transition-all scale-102"
